...
DATASETS = {
    'home_occupancy': dict(loader=lambda: utils.load_homeoccupancy(1500, 8),
                           ...
                           n_classes=3, spc=30),
    'home_har':       dict(loader=lambda: (lambda t: (t[0][:int(0.8*len(t[0]))], t[1][:int(0.8*len(t[0]))], t[0][int(0.8*len(t[0])):], t[1][int(0.8*len(t[0])):]))(utils.load_homehar(1500, 8)),
                           root='oldresults/phase1/home_har',
                           fb={}, n_classes=7, spc=30),
